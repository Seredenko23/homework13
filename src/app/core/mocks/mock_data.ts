...
export const users: User[] = [
  {id: 1, first_name: 'Susanne', last_name: 'Cudiff', email: 'scudiff0@163.com', gender: 'Female'},
  ...
  {id: 9, first_name: 'Astrid', last_name: 'Savage', email: 'asavage8@nsw.gov.au', gender: 'Female'},
  {id: 10, first_name: 'Ysabel', last_name: 'Hillitt', email: 'yhillitt9@nature.com', gender: 'Female'}
];
